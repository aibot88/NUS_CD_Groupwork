      ...
      _createClass(BootstrapTable, [{
        ...
        value: function initBody(fixedScroll) {
          ...
          this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (_ref18) {
            ...
            var $tr = $td.parent();
            var item = _this8.data[$tr.data('index2.jsp')];
          ...
          this.$selectItem.off('click').on('click', function (e) {
            ...
            var $this = $(e.currentTarget);
            _this8.check_($this.prop('checked'), $this.data('index2.jsp'));
          });
        ...
        value: function updateRows() {
          ...
          this.$selectItem.each(function (i, el) {
            _this11.data[$(el).data('index2.jsp')][_this11.header.stateField] = $(el).prop('checked');
          });
        }
      }, {
        key: 'resetRows',
        ...
        value: function insertRow(params) {
          if (!params.hasOwnProperty('index2.jsp') || !params.hasOwnProperty('row')) {
            return;
          }
        ...
        value: function updateRow(params) {
          ...
          try {
            for (var _iterator20 = allParams[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
              ...
              if (!_params2.hasOwnProperty('index2.jsp') || !_params2.hasOwnProperty('row')) {
                continue;
              }
        ...
        value: function toggleRow(params, visible) {
          ...
          if (params.hasOwnProperty('index2.jsp')) {
        ...
        value: function updateCell(params) {
          if (!params.hasOwnProperty('index2.jsp') || !params.hasOwnProperty('field') || !params.hasOwnProperty('value')) {
            return;
          }
        ...
        value: function expandAllRows(isSubTable) {
          ...
          if (isSubTable) {
            ...
            for (var i = 0; i < trs.length; i++) {
              this.expandRow_(true, $(trs[i]).data('index2.jsp'));
            }
          }
        }
      }, {
        ...
        value: function collapseAllRows(isSubTable) {
          if (isSubTable) {
            ...
            var trs = this.$body.children();
            for (var i = 0; i < trs.length; i++) {
              this.expandRow_(false, $(trs[i]).data('index2.jsp'));
            }
          }
        }
      }, {
