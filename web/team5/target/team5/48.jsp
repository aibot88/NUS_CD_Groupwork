...
<div id="main" style="height: 100%">
    <script type="text/javascript">  //;background-color: #404d5b
        ...
        var option;
        myChart.showLoading();
        $.get('partition48nodessingleedge0427.json', function (webkitDep) {
            myChart.hideLoading();
            option = {
                // color: "#404d5b",
                title: {
...
<div id="dispic" style="position:absolute;top:0;right : -1px;z-index: 999">
    <img src="./pic/dis.png" alt = "dissimilarity"/>
</div>
